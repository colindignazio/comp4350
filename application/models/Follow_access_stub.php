...
class Follow_access_stub extends CI_Model {
    private $followTable = array(
        0 => array('Follow_id' => 0, 'Follower_id' => "71", 'Followee_id' => 0),
        1 => array('Follow_id' => 2, 'Follower_id' => "71", 'Followee_id' => 3),
        2 => array('Follow_id' => 3, 'Follower_id' => "71", 'Followee_id' => 2),
    );

    private $reviewTable = array(
        0 => array('id'=>1, 'beer_id'=>'9', 'user_id'=>'71', 'store_id'=>'1',
    ...
    private function generateStubTable() {
        return array(
            ...
            1 => array('User_id'=>71, 'User_name'=>'Colin', 'User_password'=> password_hash('testpass', PASSWORD_DEFAULT), 'User_email'=>'test1@email.com', 
                'User_email_verified'=>0, 'User_email_code'=>"", 'User_location'=>'Winnipeg'),
